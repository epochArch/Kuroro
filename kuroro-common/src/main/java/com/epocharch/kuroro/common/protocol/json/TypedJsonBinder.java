 ...
 */
public final class TypedJsonBinder {

  private ObjectMapper mapper;

  private TypedJsonBinder(Include include) {
   ...
   */
  public static TypedJsonBinder getNonEmptyBinder() {
  ...
  private static class NonEmptySingletonHolder {
    ...
    public static final TypedJsonBinder nonEmptyBinder = new TypedJsonBinder(Include.NON_EMPTY);
  }
}
