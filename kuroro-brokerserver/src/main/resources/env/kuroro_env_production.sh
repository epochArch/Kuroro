...
JVM_OPTS="-server -Xms9088m -Xmx9088m -XX:PermSize=128m -XX:MaxPermSize=256m -XX:MaxDirectMemorySize=512m -XX:ParallelCMSThreads=4 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/var/www/webapps/kuroro-brokerserver -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+ExplicitGCInvokesConcurrent -XX:CMSInitiatingOccupancyFraction=70 -XX:+UseCMSInitiatingOccupancyOnly -XX:NewRatio=2 -XX:+PrintGCDetails -XX:+PrintGCTimeStamps"
